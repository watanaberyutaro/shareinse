...
"[project]/app/(protected)/admin/users/UsersClient.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function UsersClient(param) {
    ...
    const [usersList, setUsersList] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(users);
    ...
    const handleSave = async (userId)=>{
        try {
            ...
            console.log('Current user:', currentUser === null || currentUser === void 0 ? void 0 : currentUser.id);
            // 現在のユーザーの権限を確認
            const { data: currentProfile } = await supabase.from('profiles').select('role').eq('id', (currentUser === null || currentUser === void 0 ? void 0 : currentUser.id) || '').single();
            console.log('Current user role:', currentProfile === null || currentProfile === void 0 ? void 0 : currentProfile.role);
            // 部署IDが空文字の場合はnullに変換
            const updateData = {
            ...
            if (updateError) {
                ...
                showNotification('error', "更新エラー: ".concat(updateError.message));
                return;
            }
            // 更新後、データを再取得
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        children: [
            notification && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "fixed top-4 right-4 z-50 flex items-center gap-2 px-4 py-3 rounded-lg shadow-lg transition-opacity ".concat(notification.type === 'success' ? 'bg-green-50 text-green-800 border border-green-200' : 'bg-red-50 text-red-800 border border-red-200'),
                children: [
                            ...
                            children: usersList.map((user)=>{
                                ...
                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                            className: "px-6 py-4 whitespace-nowrap",
                                            children: editingUser === user.id ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                ...
                                                children: ((_user_departments = user.departments) === null || _user_departments === void 0 ? void 0 : _user_departments.name) || '未分類'
                                            }, void 0, false, {
                                                fileName: "[project]/app/(protected)/admin/users/UsersClient.tsx",
                                                lineNumber: 261,
                                                columnNumber: 21
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                            ...
                                            children: editingUser === user.id ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                ...
                                                className: "px-2 inline-flex text-xs leading-5 font-semibold rounded-full ".concat(getRoleBadgeColor(user.role)),
...
_s(UsersClient, "U3lJ4sN/pYARZlyTKOjo3kUtivg=");
_c = UsersClient;
var _c;
...
//# sourceMappingURL=_c73955fc._.js.map